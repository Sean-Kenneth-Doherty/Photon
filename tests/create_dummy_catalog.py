...
def create_dummy_lrcat(db_path):
    ...
    # Insert dummy data
    # Folders
    cursor.execute("INSERT INTO AgLibraryFolder (id_local, pathFromRoot, absolutePath, parent) VALUES (?, ?, ?, ?)", (1, 'Photos/', 'C:/Users/TestUser/Pictures/Photos/', None))
    cursor.execute("INSERT INTO AgLibraryFolder (id_local, pathFromRoot, absolutePath, parent) VALUES (?, ?, ?, ?)", (2, 'Photos/2023/', 'C:/Users/TestUser/Pictures/Photos/2023/', 1))
    cursor.execute("INSERT INTO AgLibraryFolder (id_local, pathFromRoot, absolutePath, parent) VALUES (?, ?, ?, ?)", (3, 'Photos/2024/', 'C:/Users/TestUser/Pictures/Photos/2024/', 1))
    ...
    cursor.execute("""
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
    """, (101, 'C:/Users/TestUser/Pictures/Photos/2023/', 'image1.jpg', 'image1.jpg', 2, 'JPEG', 1024000, file_create_date_1, file_mod_date_1))
    cursor.execute("""
    ...
    cursor.execute("""
        INSERT INTO AgLibraryFile (id_local, absolutePath, pathFromRoot, originalFilename, folder, fileFormat, fileSize, fileCreateDate, fileModDate) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
    """, (102, 'C:/Users/TestUser/Pictures/Photos/2024/', 'image2.dng', 'image2.dng', 3, 'DNG', 2048000, file_create_date_2, file_mod_date_2))
    cursor.execute("""
        INSERT INTO Adobe_images (id_local, rootFile, captureTime, fileWidth, fileHeight, orientation, cameraMake, cameraModel, lens, focalLength, aperture, shutterSpeed, isoSpeedRating, rating, colorLabels, pick) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
